...
date: '2021-05-15'
tagline: Designing the layout
published: false
categories: [Programming, Web Dev, Algorithms, Fitness, Stoicism, Philosophy, Nutrition, React, JavaScript, Next]
---
...
- [x] @mentions, #refs, [links](https://duckduckgo.com), **formatting**, and <del>tags</del> supported
