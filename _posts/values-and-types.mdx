...
date: '2020-11-19'
tagline: 'An overview of all values, types and operators present in JavaScript'
published: true
imgUrl: 'https://images.unsplash.com/reserve/uZYSV4nuQeyq64azfVIn_15130980706_64134efc6e_o.jpg?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80'
imgAlt: 'scattered letters'
---
