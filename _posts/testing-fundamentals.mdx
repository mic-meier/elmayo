...
It would be nice to make the code from the previous example a bit less imperative. We can write an abstraction of the assertion in a new `expect` function.
...
While the above approach makes the code much more readable it still has a few issue:
